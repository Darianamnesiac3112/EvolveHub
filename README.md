...
1. The Project Tree: Shows your existing folders and agent groups.
2. The Agent Canvas: Allows you to drag and drop different agents into tasks.
3. The Status Log: Lists the actions your agents perform in real time.
